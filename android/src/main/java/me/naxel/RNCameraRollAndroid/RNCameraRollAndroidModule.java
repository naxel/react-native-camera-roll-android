...
package me.naxel.RNCameraRollAndroid;
 ...
 */
@ReactModule(name = RNCameraRollAndroidModule.NAME)
public class RNCameraRollAndroidModule extends ReactContextBaseJavaModule {

  protected static final String NAME = "RNCameraRollAndroid";
  ...
  public RNCameraRollAndroidModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
